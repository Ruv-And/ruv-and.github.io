...
export default function Dock({
  ...
  const maxHeight = useMemo(() => panelHeight + Math.min(18, magnification * 0.15), [panelHeight, magnification]);
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center z-50">
      <motion.div
        ...
        className={`${className} fixed top-4 left-1/2 -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border border-white/10 pb-2 px-4 bg-slate-900/75 backdrop-blur-xl shadow-lg shadow-black/30 z-50`}
